...
class Context {
	...
	private function cloneContext(Context $context) {
	...
	public function addSharedInstance($name, $instance) { $this->sharedInstances [$name] = $instance; }

	public function getSharedInstance($name) { return $this->getSharedInstance($name); }

	public function getInvokeClassName() { return $this->invokeClassName; }

	public function getInvokeMethodName() { return $this->invokeMethodName; }
}